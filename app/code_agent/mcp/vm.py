...
def upload_directory_to_vm(
        local_dir: Annotated[str, Field(description="本地文件目录", examples="./.temp/vue2-test")],
...
if __name__ == "__main__":
    ...
    print(upload_directory_to_vm(local_dir="./.temp/vue3-test", vm_dest_dir="/usr/share/nginx/uploads/vue3-test"))